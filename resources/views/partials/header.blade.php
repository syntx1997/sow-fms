                ...
                <ul class="navbar-nav header-right main-notification">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            <img src="{{ asset('storage/users-avatar/' . auth()->user()->avatar) }}" width="20" alt="">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="{{ auth()->user()->role == 'Administrator' ? url('/dashboard/admin/settings') : url('/dashboard/staff/settings') }}" class="dropdown-item ai-icon">
                                <i class="flaticon-073-settings text-success"></i>
                                <span class="ml-2">Settings </span>
                            </a>
                            <a href="#" id="logout-btn" class="dropdown-item ai-icon">
