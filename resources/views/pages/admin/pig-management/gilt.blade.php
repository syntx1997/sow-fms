...
{{--                    <h4 class="card-title mb-2">Pig Management</h4>--}}
                ...
                <button class="btn btn-info" data-toggle="modal" data-target="#addPigModal"><i class="fa fa-plus"></i> Add Gilt</button>
            </div>
            <div class="card-body">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form id="addPigForm" class="modal-content">
                ...
                <div class="modal-footer">
                    <input type="hidden" name="type" value="Gilt">
    ...
    <div id="editPigModal" class="modal fade" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <form id="editPigForm" class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="fa fa-edit"></i> Edit Gilt
                    </h5>
                    <button type="button" class="close" data-dismiss="modal">
                        <span>&times;</span>
                    </button>
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-3">Gilt No.</label>
                        <div class="col-9">
